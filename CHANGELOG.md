...
- Multi-provider barcode lookup (`usda`, `openfoodfacts`) with local SQLite cache, provider selection, setup helper commands, and local barcode nutrition overrides.
